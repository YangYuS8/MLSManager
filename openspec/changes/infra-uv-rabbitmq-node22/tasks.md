...
- [x] 2.1 Create `worker_agent/pyproject.toml` with dependencies
- [x] 2.2 Create `worker_agent/ruff.toml` for linting config
- [x] 2.3 Create `worker_agent/Dockerfile` to use uv
- [x] 2.4 Remove `worker_agent/requirements.txt`
...
## 5. Documentation
- [x] 5.1 Update `AGENTS.md` with new dependencies info and worker_agent commands
